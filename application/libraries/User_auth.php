...
class User_auth
{
	...
	function get_name()
	{
		...
		return ucfirst($user_data['first_name'])." ".ucfirst($user_data["last_name"]);
	}
	/**
	 * Get login_id
	 *
	...
	function get_site_type()
	{
		...
		return $user_data['site_type'];
	}
	/*Get User Hospital ID*/
	function get_user_hospital_id()
	{
		$user_data = $this->ci->session->userdata("user_data");
		
		return $user_data['hospital_id'];
	}
	
	/*Get User Cluster ID*/
	function get_user_cluster_id()
	{
		$user_data = $this->ci->session->userdata("user_data");
	...
	private function create_autologin($user_id)
	{
		...
		echo $key;
		/*$this->ci->load->model('admin/session_model');
