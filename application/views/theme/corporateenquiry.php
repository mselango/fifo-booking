...
<main class="page-main">
      <div class="intro-page d-flex align-items-center">
        ...
        <div class="container p-5 text-center">
          <h1 class="text-uppercase fw-bold">Corporate Enquiry</h1>
        </div>
      </div>
      <div class="bg-white">
        <nav class="breadcrumb-nav d-flex align-items-center" aria-label="breadcrumb">
          <div class="container">
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active" aria-current="page"><span>Corporate Enquiry</span></li>
            </ol>
          </div>
        </nav>
      </div>
      <div class="page-content">
        ...
        <div class="col-lg-4">
          <section class="sidebar__card card">
            ...
            <form class="sidebar__subscribe" action="<?php echo BASE_URL; ?>corporateenquiry" method="POST" data-toggle="validator">
              <div class="form-group">
                <select class="form-control" name="yourtravelagent" required>
                  <option value="I am owner">I am owner</option>
                  <option value="I am admin">I am admin</option>
                  <option value="I am HR">I am HR</option>
                  <option value="I am Employee">I am Employee</option>
