! function() {
    ...
    $(window).on("resize", function() {
        ...
        g.init(), g.resize(), $("#zip").mask("00000-000"), $("#card_number").mask("0000-0000-0000-0000"), $("#card_date").mask("0000/00"), $("#card_cv2").mask("000"), $("#phone").mask("(000) 000-0000"), $.fn.validator.Constructor.FOCUS_OFFSET = r.height() + 10, $(".js-form-booking-example").validator().on("submit", function(e) {
        ...
        u.spinner({
            min: 0
        }), $("#hotelDate1,#hotelDateTo1").flatpickr({
            dateFormat: "D,d M",
            minDate: "today"
